...
const SUMMARY: Record<string, string> = {
  "/": "overview read-only mcp fork aws graph modeled result git branch for your cloud",
  ...
  "/docs/faq": "faq simple common questions non technical what is emfirge safe read only demo privacy scan time limits self hosting",
  ...
  "/docs/tools": "mcp tools overview inputs outputs index",
